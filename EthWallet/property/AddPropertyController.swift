...
class AddPropertyController: UITableViewController {
    ...
    var backBlock : ((_ entity:PropertyEntity) -> Void)?
...
//        self.performSegue(withIdentifier: "walletDetail", sender: dict)
        ...
        guard
            let keystoreData = Data.init(base64Encoded: WalletManager.manager.userEntity.keystore, options: .ignoreUnknownCharacters),
